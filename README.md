...
The project builds to an embedded system that plays Jingle Bells on a buzzer located at pin 5 of Port T on the board. It accomplishes this with a subroutine that takes a frequencty and a number of periods to play for. It uses a timer subsystem to count.
